...
public class SwiftJitsiMeetPlatformPlugin: NSObject, FlutterPlugin {
    ...
    var jitsiVC: JitsiViewController?
...
//        eventChannel.setStreamHandler(instance?)
    ...
    public func handle(_ call: FlutterMethodCall, result: @escaping FlutterResult) {
        ...
        if (call.method == "joinMeeting") {
            ...
            self.jitsiVC = JitsiViewController.init()
            ...
            let serverURL : String = self.jitsiVC?.serverUrl?.absoluteString ?? ""
            let roomName : String = self.jitsiVC?.roomName ?? ""
